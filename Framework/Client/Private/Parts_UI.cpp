...
void CParts_UI::Tick(_float fTimeDelta)
{
	...
	{
	case 0:
		GAMEINSTANCE->Add_Text(_point{ (LONG)150, (LONG)250 }, D3DCOLOR_ARGB(255, 227, 245, 244), 0.f, TEXT(": ¹ßÄ­ ÅÍ·¿ 2°³"), 0);
		break;

	case 1:
		GAMEINSTANCE->Add_Text(_point{ (LONG)150, (LONG)250 }, D3DCOLOR_ARGB(255, 227, 245, 244), 0.f, TEXT(": ¹Ì»çÀÏ ÅÍ·¿ 4°³ "), 0);
		break;

	case 2:
		GAMEINSTANCE->Add_Text(_point{ (LONG)150, (LONG)250 }, D3DCOLOR_ARGB(255, 227, 245, 244), 0.f, TEXT(": ·¹ÀÌÀú ÅÍ·¿ 4°³  "), 0);
		break;

	case 3:
		GAMEINSTANCE->Add_Text(_point{ (LONG)150, (LONG)250 }, D3DCOLOR_ARGB(255, 227, 245, 244), 0.f, TEXT(": ¹ßÄ­ ÅÍ·¿ 4°³ "), 0);
		break;
	}
	...
	if (!m_bSwitchTaget)
	{
		GAMEINSTANCE->Add_Text(_point{ (LONG)150, (LONG)250 }, D3DCOLOR_ARGB(255, 227, 245, 244), 0.f, TEXT(": ÀÏ¹Ý ÅÍ·¿ 2°³, ¹Ì»çÀÏ ÅÍ·¿ 2°³  "), 0);
	}
